...
**진행 방법**
  ...
  3. 정답을 맞추면 점수와 포인트를 획득하고 다음 문제로 넘어갑니다.
  4. 틀리면 점수와 목숨이 감소하며, 목숨이 없으면 게임이 종료됩니다.

**게임 화면**
  - 문제: 주어진 영어 단어 또는 의미
  - 선택지: 네 개의 선택지 중 하나를 선택
  - 목숨: 문제를 틀릴 때마다 감소하며, 목숨이 모두 소진되면 게임이 종료됩니다.
...
**게임 종료**
  ...
  - 받은 점수와 획득한 포인트는 게임 결과에 따라 변동되며, 사용자의 계정에 자동으로 업데이트됩니다.
''',
    },
    {
      'name': '학습 게임',
...
**진행 방법**
  ...
  3. 입력한 정답이 맞으면 점수와 포인트를 획득하고 다음 문제로 넘어갑니다.
  4. 입력한 정답이 틀리면 점수와 목숨이 감소하며, 목숨이 없으면 게임이 종료됩니다.
...
**정답 확인**
  ...
  - 정답이 맞으면 점수와 포인트를 획득하고 다음 문제로 넘어갑니다.
